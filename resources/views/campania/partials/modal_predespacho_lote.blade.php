        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row row-fluid">
                    ...
                    <div class="col-md-12 pt-2" style="display: none;" id="datos_usuario_lote_1">
                        <div class="form-group">
                            <hr />
                    ...
                    <div class="col-md-6" style="display: none;" id="nombre_usuario_lote_1">
                        <div class="form-group">
                            ...
                            {!! Form::text('usuario_nombre', null, ['placeholder'=>'Nombres del usuario','class'=>'form-control col-sm-12', 'id'=>'usuario_nombre_lote']) !!}
                        </div>
                    </div>

                    <div class="col-md-6" style="display: none;" id="apellido_usuario_lote_1">
                        <div class="form-group">
                            <label for="usuario_apellido" >Apellidos </label>
                            {!! Form::text('usuario_apellido', null, ['placeholder'=>'Apellidos del usuario','class'=>'form-control col-sm-12', 'id'=>'usuario_apellido_lote']) !!}
                        </div>
                    </div>

                    <div class="col-md-6" style="display: none;" id="rut_usuario_lote_1">
                        <div class="form-group">
                            <label for="usuario_rut" >RUT </label>
                            {!! Form::text('usuario_rut', null, ['placeholder'=>'RUT','class'=>'form-control col-sm-12', 'id'=>'usuario_rut_lote']) !!}
                        </div>
                    </div>

                    <div class="col-md-6" style="display: none;" id="email_usuario_lote_1">
                        <div class="form-group">
                            <label for="email" >Email </label>
                            {!! Form::email('email', null, ['placeholder'=>'Email','class'=>'form-control col-sm-12', 'id'=>'email_lote']) !!}
                        </div>
                    </div>
                    <div class="col-md-12 pt-2" style="display: none;" id="datos_traslado_lote_1">
                        <div class="form-group">
                            <hr />
                    ...
                    <div class="col-md-6" style="display: none;" id="ruta_origen_lote_1">
                        <div class="form-group">
                            <label for="ruta_origen" >De:</label>
                            {!! Form::text('ruta_origen', null, ['placeholder'=>'Dirección de origen', 'id' => 'search_term_ruta_lote', 'class'=>'form-control col-sm-9']) !!}
                        </div>
                    </div>
                    <div class="col-md-6" style="display: none;" id="ruta_destino_lote_1">
                        <div class="form-group">
                            <label for="ruta_destino" >A:</label>
                            {!! Form::text('ruta_destino', null, ['placeholder'=>'Dirección de destino', 'id' => 'search_term_ruta_lote_2', 'class'=>'form-control col-sm-9']) !!}
                        </div>
                    </div>
                </div>
