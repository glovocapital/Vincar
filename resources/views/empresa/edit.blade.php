                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        @endif
                            ...
                            {!! Form::select('tipo_proveedor', $tipo_proveedor, $empresa->tipo_proveedor_id,['placeholder'=>'Seleccione Tipo de Proveedor', 'class'=>'form-control col-sm-9', 'required'=>'required']) !!}
                        </div>
                    </div>
                </div>
