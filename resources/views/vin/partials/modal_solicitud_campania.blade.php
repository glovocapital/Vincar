                ...
                <div class="row row-fluid">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('tipo_campanias[]', $tipo_campanias, null,['id' => 'tipo_campanias', 'rows' => '7', 'class'=>'form-control col-sm-12 select-tipo-campanias', 'multiple' => 'multiple', 'required'=>'required']) !!}
                        </div>
