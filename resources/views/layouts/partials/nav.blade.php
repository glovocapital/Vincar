...
<nav id="sidebar" class="sidebar">
  <div class="sidebar-content ">
    ...
    @if(Auth::user()->oneRol->rol_desc == 'SuperAdministrador')
    ...
    @if(Auth::user()->oneRol->rol_desc == 'Administrador')
    <ul class="sidebar-nav">
        <li class="sidebar-item active">
            <a href="{{ route('home') }}" class="sidebar-link">
            <i class="align-middle" data-feather="home"></i> <span class="align-middle">{{ trans('menu.Inicio') }}</span>
    ...
    @if(Auth::user()->oneRol->rol_desc == 'Operador Logistico')
    ...
    @if(Auth::user()->oneRol->rol_desc == 'Customer')
    <ul class="sidebar-nav">
        <li class="sidebar-item active">
            <a href="{{ route('home') }}" class="sidebar-link">
            <i class="align-middle" data-feather="home"></i> <span class="align-middle">{{ trans('menu.Inicio') }}</span>
