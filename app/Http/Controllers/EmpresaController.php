...
class EmpresaController extends Controller
{
    ...
    {
        $pais = Pais::select('pais_id', 'pais_nombre')
            ->pluck('pais_nombre', 'pais_id');

        $tipo_proveedor = Tipo_Proveedor::select('tipo_proveedor_id','tipo_proveedor_desc')
    ...
    {
        $validate = Empresa::where('empresa_rut', $request->empresa_rut)
            ->exists();
