...
class Vin extends Model
{
     ...
     */
    protected $fillable = [
        'vin_codigo', 'vin_patente', 'vin_modelo', 'vin_marca', 'vin_color', 'vin_motor', 'vin_segmento', 'vin_fec_ingreso', 'user_id','vin_estado_inventario_id', 'vin_sub_estado_inventario_id'
    ];
